...
public class AngleDifferenceTest {
    ...
    public void testStandardRange() {
        // Test cases within the -180 to +180 range
    ...
    @Test
    public void testWiderRange() {
        // Test cases with inputs outside the -180 to +180 range
        assertEquals(-179.0679, AngleDifference.getDifference(-70099.74233810938, 29840.67437876723), 0.0001);
        assertEquals(-32.3439, AngleDifference.getDifference(-165313.6666297357, 33693.9894517456), 0.0001);
        assertEquals(-241.5029, AngleDifference.getDifference(1174.8380510598456, -154146.66490124757), 0.0001);
        assertEquals(-179.2981, AngleDifference.getDifference(60175.77306795546, 42213.07192354373), 0.0001);
    }
}
